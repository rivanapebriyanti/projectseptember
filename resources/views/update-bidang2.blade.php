            ...
            <div class="col-md-6">
                <div class="card mt-5" >
                    ...
                    <div class="card-body">
                        ...
                        <form action="/update-bidang2/{{ $bidang2->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="text" name="nama" class="form-control" id="price" placeholder="Masukkan Deskripsi" value="{{ $bidang2->nama }}">
                            </div>
                            <div class="form-group pt-2">
                                <label for="quantity">Kelas</label>
                                <input type="text" name="kelas" class="form-control" id="quantity" placeholder="Masukkan tanggal" value="{{ $bidang2->kelas }}">
                            </div>
                            <div class="form-group pt-2">
                                <label for="quantity">quotes</label>
                                <input type="link" name="quotes" class="form-control" id="quantity" placeholder="Masukkan link gdrive" value="{{ $bidang2->quotes }}">
                            </div>
