...
<body>
    ...
    <nav class="custom-navbar navbar navbar-expand-md navbar-dark fixed-top" aria-label="Furni navigation bar"
        ...
        <div class="container">
            <a class="navbar-brand" href="#">Bidang 1</a>
    ...
    <div id="layoutSidenav_content">
        <div class="container" style="margin-top: 120px">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <a href="/create-bidang1" class="btn btn-custom text-white" style="border-color :#13357B; background-color: #fff">
                        Tambah Data
                    </a>
                </div>

                <div class="col-md-6">
                    <form action="/admin-bidang1" method="post">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($bidang1 as $key => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->quotes }}</td>
                                    <td>
                                        <a href="/delete-bidang1/{{ $item->id }}" onclick="return window.confirm('Yakin hapus data ini?')"
                                            class="btn btn-danger-custom btn-sm" style="width: 80px">Hapus</a>
                                        <a href="/update-bidang1/{{ $item->id }}" class="btn btn-info-custom btn-sm" style="width: 80px; margin-top:3px">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
