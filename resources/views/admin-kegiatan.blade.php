...
<body>
    ...
    <div id="layoutSidenav_content">
        <div class="container" style="margin-top: 120px">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <a href="/create-kegiatan" class="btn btn-custom text-white" style="border-color :#13357B; background-color: #fff">
                        Tambah Data
                    </a>
                </div>
                        ...
                        <tbody>
                            @foreach ($kegiatan as $key => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->tanggal }}</td>
                                    <td><img src="{{ asset('storage/gambar/'.$item->foto) }}" alt="" style="width: 50px; height:50px"></td>
                                    <td>{{ $item->gdrive }}</td>
                                    <td>
                                        <a href="/delete-kegiatan/{{ $item->id }}" onclick="return window.confirm('Yakin hapus data ini?')"
                                            class="btn btn-danger-custom btn-sm" style="width: 80px">Hapus</a>
                                        <a href="/update-kegiatan/{{ $item->id }}" class="btn btn-info-custom btn-sm" style="width: 80px; margin-top:3px">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
