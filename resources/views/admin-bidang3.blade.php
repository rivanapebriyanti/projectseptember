...
<body>
    ...
    <div id="layoutSidenav_content">
        <div class="container" style="margin-top: 120px">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <a href="/create-bidang3" class="btn btn-custom text-white" style="border-color :#13357B; background-color: #fff">
                        Tambah Data
                    </a>
                </div>

                <div class="col-md-6">
                    <form action="/admin-bidang3" method="post">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($bidang3 as $key => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->quotes }}</td>
                                    <td>
                                        <a href="/delete-bidang3/{{ $item->id }}" onclick="return window.confirm('Yakin hapus data ini?')"
                                            class="btn btn-danger-custom btn-sm" style="width: 80px">Hapus</a>
                                        <a href="/update-bidang3/{{ $item->id }}" class="btn btn-info-custom btn-sm" style="width: 80px; margin-top:3px">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
