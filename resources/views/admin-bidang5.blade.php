...
<body>
    ...
    <nav class="custom-navbar navbar navbar-expand-md navbar-dark fixed-top" aria-label="Furni navigation bar"
        ...
        <div class="container">
            <a class="navbar-brand" href="#">Bidang 5</a>
    ...
    <div id="layoutSidenav_content">
        <div class="container" style="margin-top: 120px">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <a href="/create-bidang5" class="btn btn-custom text-white" style="border-color :#13357B; background-color: #fff">
                        Tambah Data
                    </a>
                </div>

                <div class="col-md-6">
                    <form action="/admin-bidang5" method="post">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($bidang5 as $key => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->quotes }}</td>
                                    <td>
                                        <a href="/delete-bidang5/{{ $item->id }}" onclick="return window.confirm('Yakin hapus data ini?')"
                                            class="btn btn-danger-custom btn-sm" style="width: 80px">Hapus</a>
                                        <a href="/update-bidang5/{{ $item->id }}" class="btn btn-info-custom btn-sm" style="width: 80px; margin-top:3px">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
