            ...
            <div class="col-md-6">
                <div class="card mt-5" >
                    ...
                    <div class="card-body">
                        ...
                        <form action="/update-pengumuman/{{ $pengumuman->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group pt-2">
                                <label for="productName">Judul</label>
                                <input type="text" name="judul" class="form-control" id="productName" placeholder="Edit judul pengumuman" value="{{ $pengumuman->judul }}">
                            </div>
                            <div class="form-group pt-2">
                                <label for="price">Deskripsi</label>
                                <input type="text" name="deskripsi" class="form-control" id="price" placeholder="Edit deskripsi" value="{{ $pengumuman->deskripsi }}">
                            </div>
                            <div class="form-group pt-2">
                                <label for="quantity">Tanggal</label>
                                <input type="date" name="tanggal" class="form-control" id="quantity" placeholder="Edit tanggal"  value="{{ $pengumuman->tanggal }}">
                            </div>
