...
<body>
        ...
        <div class="container py-5">
            ...
            <div class="container py-5">
                ...
                <div class="card mb-5 p-4 shadow-sm border-0">
                        <h1 class="text-center mb-4 ">{{ $item->judul }}</h1>
                        <div class="row align-items-center">
                            <div class="col-lg-6 text-center ">
                                <img src="{{ asset('storage/gambar/'.$item->foto) }}" class=" mb-4" alt="OSIS SMK YPC"
                                     style="border-radius: 15px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); max-width: 100%;">
                            </div>
                            <div class="col-lg-6">
                                <p>{{ $item->deskripsi }}</p>
                                <div class="date mt-3 text-muted">{{ $item->tanggal }}</div>
                                <a href="{{ $item->gdrive }}" class="btn rounded-pill py-2 px-4 mt-3 text-white" style="background-color: #13357B" target="_blank">
                                    Lihat drive
                                </a>
                            </div>
                        </div>
    ...
    <a href="{{ $item->gdrive }}" class="btn btn-primary rounded-pill py-2 px-4" target="_blank">Lihat drive</a>
