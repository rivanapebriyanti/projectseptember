                        ...
                        <tbody>
                            @foreach ($pengumuman as $key => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->tanggal }}</td>
                                    <td>
                                        <a href="/delete-pengumuman/{{ $item->id }}" onclick="return window.confirm('Yakin hapus data ini?')"
                                            class="btn btn-danger-custom btn-sm" style="width: 80px">Hapus</a>
                                        <a href="/update-pengumuman/{{ $item->id }}" class="btn btn-info-custom btn-sm" style="width: 80px; margin-top:3px">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
