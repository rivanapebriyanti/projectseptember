                    ...
                    <div class="card-body " >
                        <form action="/create-kegiatan" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="text" name="judul" class="form-control" id="productName" placeholder="Masukkan Judul" >
                            </div>
                            <div class="form-group pt-2">
                            ...
                            <div class="form-group pt-2">
                                <label for="quantity">Drive</label>
                                <input type="link" name="gdrive" class="form-control" id="quantity" placeholder="Masukkan link gdrive">
                            </div>
