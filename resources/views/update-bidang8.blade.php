                    ...
                    <div class="card-body">
                        ...
                        <form action="/update-bidang8/{{ $bidang8->id }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="text" name="nama" class="form-control" id="price" placeholder="Masukkan Nama" value="{{ $bidang8->nama }}">
                            </div>
                            <div class="form-group pt-2">
                                <label for="quantity">Kelas</label>
                                <input type="text" name="kelas" class="form-control" id="quantity" placeholder="Masukkan Kelas" value="{{ $bidang8->kelas }}">
                            </div>
                            <div class="form-group pt-2">
                                <label for="quantity">Quotes</label>
                                <input type="link" name="quotes" class="form-control" id="quantity" placeholder="Masukkan Quotes" value="{{ $bidang8->quotes }}">
                            </div>
